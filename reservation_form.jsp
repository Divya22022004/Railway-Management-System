...
<h1 align="center" valign="top"><font size="8" face="comic sans ms">Reserve Your Seat</font></h1>
<hr />
<%
...
<tr><td><font color="black" size="3" face="comic sans ms">Journey Date</font></td><td><input id="inputField" type="text" size="20" readonly="readonly" name="date"></tr><td></td><br>
