...
<tr><td><font color="white" face="comic sans ms" size="4">journey Date</font></td><td><input id="inputField" type="text" size="20" readonly="readonly" name="date"></tr><td></td><br>
